...
{
    public partial class DraggableDatePicker : UserControl
    {
        ...
        public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register("ViewModel",
            ...
            typeof(DraggableDatePicker));

        public DatePickerViewModel ViewModel
        {
            get { return (DatePickerViewModel)GetValue(ViewModelProperty); }
            set { SetValue(ViewModelProperty, value); }
        }

        #endregion

        public DraggableDatePicker()
        {
            InitializeComponent();
